...
function getHeader(data){
	...
	retStr+="<div id=\"logo-wrap\" onclick=\"getURL('${IndexWar}index.jsp')\"></div>\n"
	...
	retStr+="function submitSiteSearch(){window.location = '${IndexWar}searchresults.jsp?q='+ encodeURIComponent(document.getElementById('search').value + ' site:docs.rackspace.com -filetype:pdf -inurl:docs.rackspace.com/test'); return false;}\n";
	...
	retStr+="<form id=\"sitesearch\" name=\"sitesearch\" action=\"${IndexWar}searchresults.jsp\" onsubmit=\"return submitSiteSearch()\">\n";
